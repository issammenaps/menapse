...
export default function OurFootprintFourthSection(props: any) {
    ...
    <img src="/fleche-empreinte.png" className="fleche-blog  position-absolute" />
      <Section disableMargin className="my-5 main-wrapper " background={true} fullWidth={false}>
        <Grid>
          <Card HeaderTitle= {props.HeaderTitle} content={props.content} cardStyle="my-5" styleHeaderPage="text-white left-border " styleContentPage="text-white text-content " />
