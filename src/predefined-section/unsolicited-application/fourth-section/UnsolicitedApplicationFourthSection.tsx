...
export default function UnsolicitedApplicationFourthSection(props: any) {
    ...
    <img src="/fleche-solution-tpe3.png" className="fleche-solution position-absolute" />
      <Grid>
        <Card cardStyle="mt-5" styleHeaderPage="text-white left-border " styleContentPage="text-white text-content "
                   HeaderTitle={props.HeaderTitle}    content={props.content} />
